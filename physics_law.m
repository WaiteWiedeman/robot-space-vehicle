function F = physics_law(Y,sysParams)
    ...
    F(:,3) = (-((L1*M2+l1*M1)*sin(alv+th1)+b1/2*(M1+M2)*sin(alv)+l2*M2*sin(alv+th1+th2))).*xvdd ...
        ...
        + ((I0+l1^2*M1+(l2^2+L1^2)*M2+b1^2/4*(M1+M2)+b1*(L1*M2+l1*M1)*cos(th1)+2*L1*l2*M2*cos(th2)+b1*l2*M2*cos(th1+th2))).*alvdd ...
        + (((l2^2+L1^2)*M2+l1^2*M1+b1/2*l2*M2*cos(th1+th2)+b1/2*(L1*M2*l1*M1)*cos(th1)+2*L1*l2*M2*cos(th2))).*th1dd ...
        + ((l2^2*M2+b1/2*l2*M2*cos(th1+th2)+L1*l2*M2*cos(th2))).*th2dd ...
        + (-(b1/2*l2*M2*th1d.*sin(th1+th2)+b1/2*(L1*M2+l1*M1)*th1d.*sin(th1)+b1*l2*M2*alvd.*sin(th1+th2)...
        + b1*(L1*M2+l1*M1)*alvd.*sin(th1))).*th1d ...
        + (-(b1*l2*M2*sin(th1+th2).*(th2d+2*th1d+2*alvd)+L1*l2*M2*sin(th2).*(th2d+2*th1d+2*alvd))).*th2d ...
        + (((L1*M2+l1*M1)*cos(alv+th1)+b1/2*(M1+M2)*cos(alv)+l2*M2*cos(alv+th1+th2)))*G;
